...
const headerTTT = JSON.parse(scriptProperties.getProperty('headerTTT'));

// Main function for processing TTT (Text to text) data
async function mainTTT(callFromWeb = false, inputFileName = '') {
  try {
